          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-6 w-full">
            ...
            <div className="flex flex-col gap-4 sm:gap-5 w-full min-w-0">
              ...
              <motion.div
                ...
                className="glass-card-solid p-5 sm:p-6 flex-1 flex flex-col min-h-[200px] sm:min-h-[260px] lg:min-h-0 w-full"
              >
          ...
          <div style={{ padding: '40px 32px', textAlign: 'center' as const }}>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <div style={{
                ...
                ₹{formatIndianNumber(calculations.yearlySavings)}
              </div>
              <div style={{
                fontSize: '18px',
                color: '#10b981',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {calculations.yearlyCO2Saved}kg
                </div>
                <div style={{
                  fontSize: '11px',
                  opacity: 0.85,
